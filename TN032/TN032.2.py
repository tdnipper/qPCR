...
data = import_file("TN032_2_hexamers.xlsx")
...
ddct["Uninfected dusp11"] = mock["delta.dusp11"] - mock["delta.dusp11"]
# ddct['Uninfected Actin'] = mock['delta.actin'] - mock['delta.actin']
...
plt.savefig("TN032.2_hexamers.png", format="png", dpi=300)
ddct_melted.to_excel("TN032.2_hexamers_output.xlsx")
